...
export default function Clients(props) {
  return (
    <div className="h-full lg:h-[60vh] xl:h-[65vh] w-full flex flex-col items-center lg:pt-4 px-2 bg-white lg:px-40 relative">
      ...
      <div className="flex mx-0 pt-8 ">
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          className="text-gray-500 mx-6  lg:mx-16 w-12 sm:w-14 md:w-14 lg:w-16 "
          {...props}
        >
